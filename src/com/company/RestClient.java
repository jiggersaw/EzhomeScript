...
public class RestClient {
    ...
    //    private static final String STYLE_ATTR_ID = "9221463d-18ca-4b63-b09b-a2000585a00b";
    private static final String STYLE_ATTR_ID = "9221463d-18ca-4b63-b09b-a2000585a00b";

    //    private static final String CONTENT_TYPE_ID = "6d6d224e-bae0-4045-8c98-b044332ee7aa";
    private static final String CONTENT_TYPE_ID = "dbd9b78c-fbae-4931-ac30-ff218059b3c6";

    //    private static final String PROD_TYPE_ID = "f2ebc921-291a-42c6-be8d-e6f3019672fb";
    private static final String PROD_TYPE_ID = "f2ebc921-291a-42c6-be8d-e6f3019672fb";

    private static final String BRAND_SELECTED_ID = "e0e6cf4b-877d-4287-8060-a7c2406f84a1"; //The generic brand id

    //    private static final String RETAIL_SELECTED_ID = "de9d4c65-f747-4963-acfa-cea44c475fcc";
    private static final String RETAIL_SELECTED_ID = "b377bedf-a540-4376-b4d2-3d4899c1885d";

    private static final String PAINT_PAINT = "c24ea8d7-e1d8-4b26-8ef2-7753fb21f8e2"; //paint/paint
...
//    private static final String CATALOG_HOST = "ec2-54-223-154-174.cn-north-1.compute.amazonaws.com.cn";
    private static final String CATALOG_HOST = "ec2-54-223-150-170.cn-north-1.compute.amazonaws.com.cn";

    //    private static final int PORT = 9001;
    private static final int PORT = 8080;

    private static final String ADD_PROD_REST = "'{'\"name\" : \"{0}\",\"defaultName\" : \"{0}\",\"description\" : \" \",\"defaultDescription\" : \" \",\"status\" : 1,\"newFlag\" : true,\"attributes\" : [" +
            "'{'\"id\" : \"" + STYLE_ATTR_ID + "\",\"valuesIds\" : [\"{2}\"]'}', " + //style
            "'{'\"id\" : \"" + CONTENT_TYPE_ID + "\",\"valuesIds\" : [\"" + PAINT_PAINT + "\"]'}'," + //content type
            "'{'\"id\" : \"" + PROD_TYPE_ID + "\",\"valuesIds\" : [],\"free\" : [\"{0}\",\"{1}\",\"{2}\"]'}']" + //product type
...
//                style = "f7c985ee-ca1b-499f-aace-e1b8923cb177"; //Warm style
                style = "c3b8241b-4729-4c79-8d64-d63398bedfc7";
            } else {
//                style = "2079c05a-1b04-4314-9cbb-320da25acce0"; //Cold style
                style ="03300870-f4d1-4d28-8d0d-e55728ae9f38";
            }
...
//                style = "f7c985ee-ca1b-499f-aace-e1b8923cb177"; //Warm style
                style = "c3b8241b-4729-4c79-8d64-d63398bedfc7"; //Warm style
            } else {
//                style = "2079c05a-1b04-4314-9cbb-320da25acce0"; //Cold style
                style = "03300870-f4d1-4d28-8d0d-e55728ae9f38"; //Cold style
            }
